@{
    ...
    Dependencies = @{
        Modules = @()
        Cmdlets = @('Get-AppxPackage', 'Get-ChildItem', 'Get-ItemProperty', 'Join-Path', 'Select-Object', 'Sort-Object', 'Where-Object', 'Write-Error', 'Write-Output')
    ...
    Test = @{
        Categories = @('Appx', 'Registry', 'File', 'Process')
