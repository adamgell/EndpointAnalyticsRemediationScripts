@{
    ...
    Identity = @{
        ...
        Counterpart = 'Enable-Delivery-Optimization-Verbose-Logging/Detect-Enable-Delivery-Optimization-Verbose-Logging.ps1'
    }
    Runtime = @{
    ...
    Dependencies = @{
        Modules = @()
        Cmdlets = @('Enable-DeliveryOptimizationVerboseLogs')
        Executables = @()
        Policies = @()
        Endpoints = @()
    }
    ...
    Risk = @{
        Level = 'Medium'
        Destructive = $false
        UserImpact = 'The script changes the Enable Delivery Optimization Verbose Logging state and can briefly affect users or services.'
